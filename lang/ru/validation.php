...
return [
    ...
    'password' => [
        ...
        'mixed' => 'Поле :attribute должно содержать как минимум одну букву в нижнем и верхнем регистре.',
        ...
        'uncompromised' => 'Предложенное значение :attribute было в утечке данных. Пожалуйста, введите другой :attribute.',
    ],
